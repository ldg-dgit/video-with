...
(() => {
  ...
  function r() {
    ...
    function L(t, r) {
      ...
      return o
        ? o.done
          ? ((r[t.resultName] = o.value), (r.next = t.nextLoc), "return" !== r.method && ((r.method = "next"), (r.arg = void 0)), (r.delegate = null), s)
          : o
        : ((r.method = "throw"), (r.arg = new TypeError("iterator result is not an object")), (r.delegate = null), s);
    }
    function E(t) {
      var r = { tryLoc: t[0] };
    ...
    return (
      ...
      (O.prototype = {
        ...
        delegateYield: function (t, r, e) {
          return (this.delegate = { iterator: S(t), resultName: r, nextLoc: e }), "next" === this.method && (this.arg = void 0), s;
        },
      }),
      e
    );
          ...
          return r().wrap(function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  return alert("hi"), (t.next = 3), fetch("");
                case 3:
                  t.sent;
                case 4:
                case "end":
